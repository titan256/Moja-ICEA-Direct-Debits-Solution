...
namespace ICEADDI
{
    public partial class IceaDuplicates : System.Web.UI.Page
    {
        ...
        protected void FireRowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (command)
            {
                ...
                case "MarkAsArchived":
                    query = "update eftDDInstructICEA set IceaStatus='ARCHIVE' where idx26='" + autoId + "' and IceaStatus='DUPLICATE'";
                    ...
                    break;
                case "MarkAsApproved":
                    query = "update eftDDInstructICEA set IceaStatus='APPROVED' where idx26='" + autoId + "' and IceaStatus='DUPLICATE'";
                    readers = QueryDatabase(sqlconnstr, query);
                    Display.BackColor = System.Drawing.Color.Green;
                    Display.ForeColor = System.Drawing.Color.White;
                    ...
                    break;
                case "MarkAsDenied":
                    query = "update eftDDInstructICEA set IceaStatus='DENIED' where idx26='" + autoId + "' and IceaStatus='DUPLICATE'";
                    readers = QueryDatabase(sqlconnstr, query);
                    Display.BackColor = System.Drawing.Color.Green;
                    Display.ForeColor = System.Drawing.Color.White;
