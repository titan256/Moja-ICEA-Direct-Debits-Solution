<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iceaMaker.aspx.cs" Inherits="ICEADDI.WebForm1" %>
...
<body style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif">
    ...
    <asp:Label ID="wlcmlbl" runat="server" Text="Label"></asp:Label> <asp:LoginStatus ID="LoginStatus1" runat="server" LogoutAction="Redirect" LogoutPageUrl="~/default.aspx"/>  <br />
        <br />
         ...
         <div class="panel-heading">ICEA MAKER</div>
        <asp:GridView ID="MakerGrid" OnRowCommand="FireRowCommand" DataSourceID="readers" autogeneratecolumns="false" autogenerateeditbutton="true" OnRowEditing="MakerGrid_RowEditing" OnRowUpdating="MakerGrid_RowUpdating" CssClass="table table-hover table-striped" DataKeyNames="idx26" runat="server" Width="" AutoGenerateDeleteButton="False" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="">
                    ...
                    <asp:LinkButton ID="btnDeny" runat="server" CommandArgument='<%# Eval("idx26") %>'
                            CommandName ="MarkAsDenied" Text="Decline" />
                    </ItemTemplate>
                </asp:TemplateField>
             ...
             <asp:SqlDataSource runat="server" ID="readers" ConnectionString="<%$ConnectionStrings:ICEA %>" 
                 SelectCommand="select idx2 ,idx4 , idx5 ,idx6 ,idx7,idx8,idx9 ,idx11,idx13,idx15 ,idx23 ,idx26,IceaBatchNumber , IceaStatus from eftDDInstructICEA where iceastatus='MAKER'"
                 ...
                 DeleteCommand="update eftDDInstructICEA set idx15='ARCHIVE' where ( eftDDInstructICEA.idx26=@idx26) ">
             </asp:SqlDataSource>
     ...
     <div class="panel panel-default">
         <asp:Table ID="Table1" runat="server" CssClass="table table-hover table-striped" HorizontalAlign="Justify" Width="400px">
             <asp:TableRow>
                 ...
                 <asp:TableCell>
                     <asp:Button ID="cmdApproveBatch" OnClick="cmdApproveBatch_Click" runat="server"  CssClass="btn btn-success" Text="Send Batch to Checker" />
                 </asp:TableCell>
                  <asp:TableCell>
                     <asp:Button ID="cmdApproveAll" OnClick="cmdApproveAll_Click" runat="server"   CssClass="btn btn-success" Text="Send All to Checker" />
                 </asp:TableCell>
                 ...
                 <asp:TableCell>
                     <asp:Button ID="cmdDenyBatch" OnClick="cmdDenyBatch_Click" runat="server" class="btn btn-danger" Text="Decline Batch" />
                 </asp:TableCell>
                  <asp:TableCell>
                     <asp:Button ID="cmdDeleteAll" OnClick="cmdDeleteAll_Click" runat="server" class="btn btn-danger" Text="Decline All" />
                 </asp:TableCell>
