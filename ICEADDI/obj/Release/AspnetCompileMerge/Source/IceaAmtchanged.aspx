<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IceaAmtchanged.aspx.cs" Inherits="ICEADDI.IceaAmtchanged" %>
...
<body style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif">
    ...
    <div>
        ...
        <form id="form1" runat="server">
         ...
         <div class="panel-heading">AMOUNT CHANGED</div>
        <asp:GridView ID="AmtGrid" CssClass="table table-hover table-striped" DataSourceID="readers" autogeneratecolumns="false" OnRowCommand="FireRowCommand"  DataKeyNames="idx26" runat="server" Width="">
           <Columns>
              ...
              <asp:SqlDataSource runat="server" ID="readers" ConnectionString="<%$ConnectionStrings:ICEA %>" 
                 SelectCommand="select idx2 ,idx4 , idx5 ,idx6 ,idx7,idx8,idx9 ,idx11,idx13,idx15 ,idx23 ,idx26,IceaBatchNumber , IceaStatus from eftDDInstructICEA where iceastatus='AMTCHANGED'"
                 UpdateCommand="update eftDDInstructICEA set idx5=@idx5,idx2=@idx2,idx4=@idx4, idx6=@idx6,idx7=@idx7,idx8=@idx8,idx9=@idx9,idx11=@idx11,idx23=@idx23 where ( eftDDInstructICEA.idx26=@idx26) AND  iceastatus='AMTCHANGED'">
