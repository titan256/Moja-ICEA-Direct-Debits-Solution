<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iceaDenied.aspx.cs" Inherits="ICEADDI.WebForm4" %>
...
<body style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif">
   ...
   <div class="panel panel-primary" style="width:100%" >
        ...
        <asp:GridView ID="DeniedGrid" CssClass="table table-hover table-striped" DataSourceID="readers" runat="server" OnRowCommand="FireRowCommand" AutoGenerateColumns="False" >
                       <Columns>
              <asp:TemplateField HeaderText="">
                ...
                <asp:TemplateField HeaderText="">
                    ...
                    <asp:LinkButton ID="btnApprove" runat="server" CommandArgument='<%# Eval("idx26") %>'
                            CommandName ="MarkAsApproved" Text="Checker" />
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:SqlDataSource runat="server" ID="readers" ConnectionString="<%$ConnectionStrings:ICEA %>" 
                 SelectCommand="select idx2 ,idx4 , idx5 ,idx6 ,idx7,idx8,idx9 ,idx11,idx13,idx15 ,idx23 ,idx26,IceaBatchNumber , IceaStatus from eftDDInstructICEA where iceastatus='DENIED'"
