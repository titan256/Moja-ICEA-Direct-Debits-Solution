...
namespace ICEADDI
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void cmdDeleteAll_Click(object sender, EventArgs e)
        {
            try
            {
                string query = "update eftDDInstructICEA set IceaStatus='DENIED' where IceaStatus='CHECKER'";
                SqlDataReader readers = QueryDatabase(sqlconnstr, query);
                Display.BackColor = System.Drawing.Color.Red;
                Display.ForeColor = System.Drawing.Color.White;
        ...
        protected void cmdApproveBatch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "update eftDDInstructICEA set IceaStatus='APPROVED' where IceaBatchNumber= " + btc;
                SqlDataReader readers = QueryDatabase(sqlconnstr, query);
        ...
        {
                try{
                string query = "update eftDDInstructICEA set IceaStatus='APPROVED' where IceaStatus='CHECKER'";
                SqlDataReader readers = QueryDatabase(sqlconnstr, query);
                Display.BackColor = System.Drawing.Color.Green;
                Display.ForeColor = System.Drawing.Color.White;
        ...
        protected void CheckerGrid_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            int inde = CheckerGrid.EditIndex;
            GridViewRow row = CheckerGrid.Rows[inde];
        ...
        protected void FireRowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (command)
            {
                ...
                case "MarkAsArchived":
                    query = "update eftDDInstructICEA set IceaStatus='ARCHIVE' where idx26='" + autoId + "' and IceaStatus='CHECKER'";
                    ...
                    break;
                case "MarkAsApproved":
                    query = "update eftDDInstructICEA set IceaStatus='APPROVED' where idx26='" + autoId + "' and IceaStatus='CHECKER'";
                    readers = QueryDatabase(sqlconnstr, query);
                    Display.BackColor = System.Drawing.Color.Green;
                    Display.ForeColor = System.Drawing.Color.White;
                    Display.Text = "Items have been sent for Approval";
        ...
        protected void CheckerGrid_RowEditing(object sender, GridViewEditEventArgs e)
        {
